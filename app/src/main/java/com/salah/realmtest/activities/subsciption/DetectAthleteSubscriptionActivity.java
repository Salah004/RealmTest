...
public class DetectAthleteSubscriptionActivity extends AppCompatActivity implements  OnQRCodeReadListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            PermissionManager permissionManager = PermissionManager.getInstance(DetectAthleteSubscriptionActivity.this);
            permissionManager.checkPermissions(singleton(Manifest.permission.CAMERA), new PermissionManager.PermissionRequestListener() {
                ...
                public void onPermissionGranted() {
                    Toasty.success(DetectAthleteSubscriptionActivity.this, "Permissions Granted", Toast.LENGTH_SHORT).show();
                    initQRCodeReaderView();
                }

                @Override
                public void onPermissionDenied() {
                    Toasty.error(DetectAthleteSubscriptionActivity.this, "Permissions Denied", Toast.LENGTH_SHORT).show();
                }
            });
        }else {
            initQRCodeReaderView();
    ...
    @Override public void onQRCodeRead(String text, PointF[] points) {
        if( ALLOW_DETECT ){
            ...
            if (athlete!=null){
                ...
                Intent intent = new Intent(DetectAthleteSubscriptionActivity.this,SubscriptionsActivity.class);
